...
"""
Moved to `hospital-service/scripts/login_test.py`.
...
print("This helper script has moved to: hospital-service/scripts/login_test.py")
print("Run: python hospital-service/scripts/login_test.py")
sys.exit(0)
